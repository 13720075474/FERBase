...
#define  CF_Color_TextDarkGrayColor UIColorFromHex(0x000000)
#define  CF_Color_SepertLineColor UIColorFromHex(0xdddddd)
#define  CF_Color_DefaultColor  UIColorFromHex(0x000000)  // 默认的颜色
#define  CF_Color_DefalutBackGr oundColor UIColorFromHex(0xf2f2f2)
